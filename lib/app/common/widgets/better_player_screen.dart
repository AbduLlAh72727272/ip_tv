...
class BetterPlayerScreen extends StatefulWidget {
  ...
  const BetterPlayerScreen({Key? key, required this.streamUrl})
      : super(key: key);
...
class _BetterPlayerScreenState extends State<BetterPlayerScreen>
  ...
  //   if (position != null) {
  //     _betterPlayerController.seekTo(Duration(seconds: position.inSeconds + 10));
  //   }
  // }
  //
  // void rewind() {
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          //   right: 0,
          //   child: Slider(
          //     value: _betterPlayerController.videoPlayerController?.value.position.inSeconds.toDouble() ?? 0,
          //     min: 0,
          //     max: _betterPlayerController.videoPlayerController?.value.duration?.inSeconds.toDouble() ?? 0,
          //     onChanged: (value) {
          //       _betterPlayerController.seekTo(Duration(seconds: value.toInt()));
          //     },
          ...
          //   left: 20.w,
          //   child: Text(
          //     formatDuration(_betterPlayerController.videoPlayerController?.value.position ?? Duration.zero),
