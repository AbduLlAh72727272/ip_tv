...
class SeriesView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: VoidColors.primary, // Set background color from theme
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: Row(
            children: [
              Image.asset(
                'assets/images/vpn.png', // Add your VPN logo here
                height: 30.h,
              ),
              SizedBox(width: 2.w),
        ...
        child: Column(
          children: [
            Container(
              ...
              height: 300.h, // Adjusted height for the main image
              child: Stack(
                children: [
                  Image.asset(
